...
window.openProgressDetail = async function(exerciseId, exerciseName) {
    ...
    document.getElementById('ex-detail-cat').textContent = "Yükleniyor...";
    ...
    document.getElementById('ex-detail-total-sessions').textContent = "0";
    document.getElementById('ex-detail-history-list').innerHTML = `<div class="text-center text-sm text-[#64748B] py-8">Veriler yükleniyor...</div>`;
